        ...
        <>
          ...
          <Group justify="center" align="center" mb={"md"}>
            ...
            <MultiSelect
              ...
              onChange={(e) =>
                handleChangeArray(e, "communication&connect", "networkSupport")
              }
            />
            <Select
              placeholder="Select an option"
              ...
              label="Charge port"
              onChange={(e) => handleChange(e, "communication&connect", "port")}
            />
            <MultiSelect
              placeholder="Select options"
              data={dataMaterial}
            ...
            <Select
              ...
              data={dataMaterial}
              label="GPS"
              onChange={(e) => handleChange(e, "communication&connect", "gps")}
            />
            <MultiSelect
              placeholder="Select options"
              data={dataMaterial}
              ...
              onChange={(e) =>
                handleChangeArray(e, "communication&connect", "otherConnection")
              }
            />
          </Group>
        </>
